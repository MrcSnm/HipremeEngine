...
#ifndef _SGX535DEFS_H_
#define	_SGX535DEFS_H_

#if !defined (SGX_CORE_REV) && !defined (USE_SGX_CORE_REV_HEAD)
#error sgx535defs.h requires SGX_CORE_REV or USE_SGX_CORE_REV_HEAD to be defined
#endif
...
#define EUR_CR_DEBUG_BLOCK_SELECT_B_MASK    0x000F0000U
#define EUR_CR_DEBUG_BLOCK_SELECT_B_SHIFT   16

#define EUR_CR_DEBUG_BLOCK_SELECT_A_MASK    0x0F000000U
...
#if defined (USE_SGX_CORE_REV_HEAD) || (SGX_CORE_REV >= 111)
...
/* Register EUR_CR_CLIP_DIAG1 */
#define EUR_CR_CLIP_DIAG1                   0x0300
#define EUR_CR_CLIP_DIAG1_CLIP_VTX_COUNT_MASK 0x0000FFFFU
#define EUR_CR_CLIP_DIAG1_CLIP_VTX_COUNT_SHIFT 0

#define EUR_CR_CLIP_DIAG1_CLIP_PRIMTV_COUNT_MASK 0xFFFF0000U
#define EUR_CR_CLIP_DIAG1_CLIP_PRIMTV_COUNT_SHIFT 16
...
/* Register EUR_CR_PIXELBE_SIG11 */
#define EUR_CR_PIXELBE_SIG11                0x0310
#define EUR_CR_PIXELBE_SIG11_SIGNATURE_MASK 0xFFFFFFFFU
#define EUR_CR_PIXELBE_SIG11_SIGNATURE_SHIFT 0

/* Register EUR_CR_PIXELBE_SIG12 */
#define EUR_CR_PIXELBE_SIG12                0x0314
#define EUR_CR_PIXELBE_SIG12_SIGNATURE_MASK 0xFFFFFFFFU
#define EUR_CR_PIXELBE_SIG12_SIGNATURE_SHIFT 0

/* Register EUR_CR_TA_TTE */
#define EUR_CR_TA_TTE                       0x0320
#define EUR_CR_TA_TTE_CSM_MASK              0x000000FFU
#define EUR_CR_TA_TTE_CSM_SHIFT             0

#define EUR_CR_TA_TTE_TPC_MASK              0x0000FF00U
#define EUR_CR_TA_TTE_TPC_SHIFT             8

#define EUR_CR_TA_TTE_DPM_MASK              0x00FF0000U
#define EUR_CR_TA_TTE_DPM_SHIFT             16

#define EUR_CR_TA_TTE_TE_PAD128_MASK        0x01000000U
#define EUR_CR_TA_TTE_TE_PAD128_SHIFT       24

#define EUR_CR_TA_TTE_TE_PAD256_MASK        0x02000000U
#define EUR_CR_TA_TTE_TE_PAD256_SHIFT       25
...
#define EUR_CR_PIXELBE_TTE0_MASK            0x0000FF00U
#define EUR_CR_PIXELBE_TTE0_SHIFT           8

#define EUR_CR_PIXELBE_TTE1_MASK            0x00FF0000U
#define EUR_CR_PIXELBE_TTE1_SHIFT           16

#define EUR_CR_PIXELBE_BARTLETT_ENABLE_MASK 0x01000000U
#define EUR_CR_PIXELBE_BARTLETT_ENABLE_SHIFT 24
...
#if defined (USE_SGX_CORE_REV_HEAD) || (SGX_CORE_REV >= 111)
/* Register EUR_CR_RAST_ROUNDMODE */
#define EUR_CR_RAST_ROUNDMODE               0x0444
#define EUR_CR_RAST_ROUNDMODE_TSP_MASK      0x0000000CU
#define EUR_CR_RAST_ROUNDMODE_TSP_SHIFT     2

#define EUR_CR_RAST_ROUNDMODE_DEPTH_MASK    0x00000003U
#define EUR_CR_RAST_ROUNDMODE_DEPTH_SHIFT   0
#endif
...
#define EUR_CR_ISP_STENCIL_LOAD_BASE_ADDR_MASK 0x0FFFFFF0U
...
#define EUR_CR_ISP_STENCIL_STORE_BASE_ADDR_MASK 0x0FFFFFF0U
...
#if defined (USE_SGX_CORE_REV_HEAD) || (SGX_CORE_REV >= 111)
/* Register EUR_CR_MADD_ARB_CFG */
#define EUR_CR_MADD_ARB_CFG                 0x080C
#define EUR_CR_MADD_ARB_CFG_TEX_NON_TEX_MASTER_THRESHOLD_MASK 0x000001FFU
#define EUR_CR_MADD_ARB_CFG_TEX_NON_TEX_MASTER_THRESHOLD_SHIFT 0

#define EUR_CR_MADD_ARB_CFG_NON_TEX_MASTER_THRESHOLD_MASK 0x0003FE00U
#define EUR_CR_MADD_ARB_CFG_NON_TEX_MASTER_THRESHOLD_SHIFT 9

#define EUR_CR_MADD_ARB_CFG_ENABLE_MASK     0x00040000U
#define EUR_CR_MADD_ARB_CFG_ENABLE_SHIFT    18
#endif
...
#define EUR_CR_USE_CTRL_CACHE_TTE_MASK      0x00000FF0U
#define EUR_CR_USE_CTRL_CACHE_TTE_SHIFT     4

#define EUR_CR_USE_CTRL_ST_TTE_SCALE_MASK   0x00003000U
#define EUR_CR_USE_CTRL_ST_TTE_SCALE_SHIFT  12
...
/* Register EUR_CR_PDS_DEBUG_SR */
#define EUR_CR_PDS_DEBUG_SR                 0x0AB0
#define EUR_CR_PDS_DEBUG_SR_VALUE_MASK      0x00000FFFU
#define EUR_CR_PDS_DEBUG_SR_VALUE_SHIFT     0
...
/* Register EUR_CR_PDS_DEBUG_PC */
#define EUR_CR_PDS_DEBUG_PC                 0x0AC0
#define EUR_CR_PDS_DEBUG_PC_VALUE_MASK      0x00000FFFU
#define EUR_CR_PDS_DEBUG_PC_VALUE_SHIFT     0
...
#endif /* _SGX535DEFS_H_ */

/*****************************************************************************
 End of file (sgx535defs.h)
*****************************************************************************/
