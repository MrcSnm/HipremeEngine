...
final class HipVertexArrayObject
{
    ...
    */
    ...
    {
        assert(infos.length != 0, "No vertex buffer was created before setting its vertices");
    ...
    {
        assert(infos.length != 0, "No vertex buffer was created before setting its vertices");
        assert(hasVertexInitialized, "Vertex must setData before updating its contents.");
    ...
    */
    ...
    {
        assert(EBO !is null, "No index buffer was created before setting its indices");
    ...
    */
    ...
    {
        assert(EBO !is null, "No index buffer was created before setting its indices");
        assert(hasIndexInitialized, "Index must setData before updating its contents.");
