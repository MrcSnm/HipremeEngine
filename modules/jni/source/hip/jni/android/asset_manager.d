module hip.jni.android.asset_manager;
version(Android):
extern(C):
alias off_t = int;
alias off64_t = long;
...
// #if !defined(__ANDROID__) && !defined(__RENAME_IF_FILE_OFFSETd64)
// #define __RENAME_IF_FILE_OFFSETd64(x)
// #endif
...
*/   
off64_t AAsset_seek64(AAsset* asset, off64_t offset, int whence); //AAset_seek64
/**
* Seek to the specified offset within the asset data.  'whence' uses the
* same constants as lseek()/fseek().
*
