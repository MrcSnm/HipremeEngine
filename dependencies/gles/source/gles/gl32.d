...
extern(C)
{
    ...
    void glTexStorage3DMultisample(uint, int, uint, int, int, int, ubyte) @nogc nothrow;
    void glTexBufferRange(uint, uint, uint, c_long, c_long) @nogc nothrow;
    void glTexBuffer(uint, uint, uint) @nogc nothrow;
    void glGetSamplerParameterIuiv(uint, uint, uint*) @nogc nothrow;
    void glGetSamplerParameterIiv(uint, uint, int*) @nogc nothrow;
    void glSamplerParameterIuiv(uint, uint, const(uint)*) @nogc nothrow;
    void glSamplerParameterIiv(uint, uint, const(int)*) @nogc nothrow;
    void glGetTexParameterIuiv(uint, uint, uint*) @nogc nothrow;
    void glGetTexParameterIiv(uint, uint, int*) @nogc nothrow;
    void glTexParameterIuiv(uint, uint, const(uint)*) @nogc nothrow;
    void glTexParameterIiv(uint, uint, const(int)*) @nogc nothrow;
    void glPatchParameteri(uint, int) @nogc nothrow;
    void glMinSampleShading(float) @nogc nothrow;
    void glGetnUniformuiv(uint, int, int, uint*) @nogc nothrow;
    void glGetnUniformiv(uint, int, int, int*) @nogc nothrow;
    void glGetnUniformfv(uint, int, int, float*) @nogc nothrow;
    void glReadnPixels(int, int, int, int, uint, uint, int, void*) @nogc nothrow;
    uint glGetGraphicsResetStatus() @nogc nothrow;
    void glPrimitiveBoundingBox(float, float, float, float, float, float, float, float) @nogc nothrow;
    void glFramebufferTexture(uint, uint, uint, int) @nogc nothrow;
    void glDrawElementsInstancedBaseVertex(uint, int, uint, const(void)*, int, int) @nogc nothrow;
    void glDrawRangeElementsBaseVertex(uint, uint, uint, int, uint, const(void)*, int) @nogc nothrow;
    void glDrawElementsBaseVertex(uint, int, uint, const(void)*, int) @nogc nothrow;
    ubyte glIsEnabledi(uint, uint) @nogc nothrow;
    void glColorMaski(uint, ubyte, ubyte, ubyte, ubyte) @nogc nothrow;
    void glBlendFuncSeparatei(uint, uint, uint, uint, uint) @nogc nothrow;
    void glBlendFunci(uint, uint, uint) @nogc nothrow;
    void glBlendEquationSeparatei(uint, uint, uint) @nogc nothrow;
    void glBlendEquationi(uint, uint) @nogc nothrow;
    void glDisablei(uint, uint) @nogc nothrow;
    void glEnablei(uint, uint) @nogc nothrow;
    void glGetPointerv(uint, void**) @nogc nothrow;
    void glGetObjectPtrLabel(const(void)*, int, int*, char*) @nogc nothrow;
    void glObjectPtrLabel(const(void)*, int, const(char)*) @nogc nothrow;
    void glGetObjectLabel(uint, uint, int, int*, char*) @nogc nothrow;
    void glObjectLabel(uint, uint, int, const(char)*) @nogc nothrow;
    void glPopDebugGroup() @nogc nothrow;
    void glPushDebugGroup(uint, uint, int, const(char)*) @nogc nothrow;
    uint glGetDebugMessageLog(uint, int, uint*, uint*, uint*, uint*, int*, char*) @nogc nothrow;
    void glDebugMessageCallback(void function(uint, uint, uint, uint, int, const(char)*, const(void)*), const(void)*) @nogc nothrow;
    void glDebugMessageInsert(uint, uint, uint, uint, int, const(char)*) @nogc nothrow;
    void glDebugMessageControl(uint, uint, uint, int, const(uint)*, ubyte) @nogc nothrow;
    void glCopyImageSubData(uint, uint, int, int, int, int, uint, uint, int, int, int, int, int, int, int) @nogc nothrow;
    void glBlendBarrier() @nogc nothrow;
    alias PFNGLTEXSTORAGE3DMULTISAMPLEPROC = void function(uint, int, uint, int, int, int, ubyte);
    alias PFNGLTEXBUFFERRANGEPROC = void function(uint, uint, uint, c_long, c_long);
    alias PFNGLTEXBUFFERPROC = void function(uint, uint, uint);
    alias PFNGLGETSAMPLERPARAMETERIUIVPROC = void function(uint, uint, uint*);
    alias PFNGLGETSAMPLERPARAMETERIIVPROC = void function(uint, uint, int*);
    alias PFNGLSAMPLERPARAMETERIUIVPROC = void function(uint, uint, const(uint)*);
    alias PFNGLSAMPLERPARAMETERIIVPROC = void function(uint, uint, const(int)*);
    alias PFNGLGETTEXPARAMETERIUIVPROC = void function(uint, uint, uint*);
    alias PFNGLGETTEXPARAMETERIIVPROC = void function(uint, uint, int*);
    alias PFNGLTEXPARAMETERIUIVPROC = void function(uint, uint, const(uint)*);
    alias PFNGLTEXPARAMETERIIVPROC = void function(uint, uint, const(int)*);
    alias PFNGLPATCHPARAMETERIPROC = void function(uint, int);
    alias PFNGLMINSAMPLESHADINGPROC = void function(float);
    alias PFNGLGETNUNIFORMUIVPROC = void function(uint, int, int, uint*);
    alias PFNGLGETNUNIFORMIVPROC = void function(uint, int, int, int*);
    alias PFNGLGETNUNIFORMFVPROC = void function(uint, int, int, float*);
    alias PFNGLREADNPIXELSPROC = void function(int, int, int, int, uint, uint, int, void*);
    alias PFNGLGETGRAPHICSRESETSTATUSPROC = uint function();
    alias PFNGLPRIMITIVEBOUNDINGBOXPROC = void function(float, float, float, float, float, float, float, float);
    alias PFNGLFRAMEBUFFERTEXTUREPROC = void function(uint, uint, uint, int);
    alias PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXPROC = void function(uint, int, uint, const(void)*, int, int);
    alias PFNGLDRAWRANGEELEMENTSBASEVERTEXPROC = void function(uint, uint, uint, int, uint, const(void)*, int);
    alias PFNGLDRAWELEMENTSBASEVERTEXPROC = void function(uint, int, uint, const(void)*, int);
    alias PFNGLISENABLEDIPROC = ubyte function(uint, uint);
    alias PFNGLCOLORMASKIPROC = void function(uint, ubyte, ubyte, ubyte, ubyte);
    alias PFNGLBLENDFUNCSEPARATEIPROC = void function(uint, uint, uint, uint, uint);
    alias PFNGLBLENDFUNCIPROC = void function(uint, uint, uint);
    alias PFNGLBLENDEQUATIONSEPARATEIPROC = void function(uint, uint, uint);
    alias PFNGLBLENDEQUATIONIPROC = void function(uint, uint);
    alias GLbyte = byte;
    ...
    alias GLsizei = int;
    alias GLubyte = ubyte;
    alias PFNGLDISABLEIPROC = void function(uint, uint);
    alias PFNGLENABLEIPROC = void function(uint, uint);
    alias PFNGLGETPOINTERVPROC = void function(uint, void**);
    alias PFNGLGETOBJECTPTRLABELPROC = void function(const(void)*, int, int*, char*);
    alias PFNGLOBJECTPTRLABELPROC = void function(const(void)*, int, const(char)*);
    alias PFNGLGETOBJECTLABELPROC = void function(uint, uint, int, int*, char*);
    alias PFNGLOBJECTLABELPROC = void function(uint, uint, int, const(char)*);
    alias PFNGLPOPDEBUGGROUPPROC = void function();
    alias PFNGLPUSHDEBUGGROUPPROC = void function(uint, uint, int, const(char)*);
    alias PFNGLGETDEBUGMESSAGELOGPROC = uint function(uint, int, uint*, uint*, uint*, uint*, int*, char*);
    alias PFNGLDEBUGMESSAGECALLBACKPROC = void function(void function(uint, uint, uint, uint, int, const(char)*, const(void)*), const(void)*);
    alias PFNGLDEBUGMESSAGEINSERTPROC = void function(uint, uint, uint, uint, int, const(char)*);
    alias PFNGLDEBUGMESSAGECONTROLPROC = void function(uint, uint, uint, int, const(uint)*, ubyte);
    alias PFNGLCOPYIMAGESUBDATAPROC = void function(uint, uint, int, int, int, int, uint, uint, int, int, int, int, int, int, int);
    alias PFNGLBLENDBARRIERPROC = void function();
    alias GLDEBUGPROC = void function(uint, uint, uint, uint, int, const(char)*, const(void)*);
    ...
    static if(!is(typeof(GL_ES_VERSION_3_2))) {
        private enum enumMixinStr_GL_ES_VERSION_3_2 = `enum GL_ES_VERSION_3_2 = 1;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_ES_VERSION_3_2); }))) {
            mixin(enumMixinStr_GL_ES_VERSION_3_2);
        }
    }
    ...
    static if(!is(typeof(GL_MULTISAMPLE_LINE_WIDTH_RANGE))) {
        private enum enumMixinStr_GL_MULTISAMPLE_LINE_WIDTH_RANGE = `enum GL_MULTISAMPLE_LINE_WIDTH_RANGE = 0x9381;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MULTISAMPLE_LINE_WIDTH_RANGE); }))) {
            mixin(enumMixinStr_GL_MULTISAMPLE_LINE_WIDTH_RANGE);
        }
    }
    ...
    static if(!is(typeof(GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY))) {
        private enum enumMixinStr_GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY = `enum GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY = 0x9382;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY); }))) {
            mixin(enumMixinStr_GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY);
        }
    }
    ...
    static if(!is(typeof(GL_MULTIPLY))) {
        private enum enumMixinStr_GL_MULTIPLY = `enum GL_MULTIPLY = 0x9294;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MULTIPLY); }))) {
            mixin(enumMixinStr_GL_MULTIPLY);
        }
    }
    ...
    static if(!is(typeof(GL_SCREEN))) {
        private enum enumMixinStr_GL_SCREEN = `enum GL_SCREEN = 0x9295;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SCREEN); }))) {
            mixin(enumMixinStr_GL_SCREEN);
        }
    }
    ...
    static if(!is(typeof(GL_OVERLAY))) {
        private enum enumMixinStr_GL_OVERLAY = `enum GL_OVERLAY = 0x9296;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_OVERLAY); }))) {
            mixin(enumMixinStr_GL_OVERLAY);
        }
    }
    ...
    static if(!is(typeof(GL_DARKEN))) {
        private enum enumMixinStr_GL_DARKEN = `enum GL_DARKEN = 0x9297;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DARKEN); }))) {
            mixin(enumMixinStr_GL_DARKEN);
        }
    }
    ...
    static if(!is(typeof(GL_LIGHTEN))) {
        private enum enumMixinStr_GL_LIGHTEN = `enum GL_LIGHTEN = 0x9298;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_LIGHTEN); }))) {
            mixin(enumMixinStr_GL_LIGHTEN);
        }
    }
    ...
    static if(!is(typeof(GL_COLORDODGE))) {
        private enum enumMixinStr_GL_COLORDODGE = `enum GL_COLORDODGE = 0x9299;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COLORDODGE); }))) {
            mixin(enumMixinStr_GL_COLORDODGE);
        }
    }
    ...
    static if(!is(typeof(GL_COLORBURN))) {
        private enum enumMixinStr_GL_COLORBURN = `enum GL_COLORBURN = 0x929A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COLORBURN); }))) {
            mixin(enumMixinStr_GL_COLORBURN);
        }
    }
    ...
    static if(!is(typeof(GL_HARDLIGHT))) {
        private enum enumMixinStr_GL_HARDLIGHT = `enum GL_HARDLIGHT = 0x929B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_HARDLIGHT); }))) {
            mixin(enumMixinStr_GL_HARDLIGHT);
        }
    }
    ...
    static if(!is(typeof(GL_SOFTLIGHT))) {
        private enum enumMixinStr_GL_SOFTLIGHT = `enum GL_SOFTLIGHT = 0x929C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SOFTLIGHT); }))) {
            mixin(enumMixinStr_GL_SOFTLIGHT);
        }
    }
    ...
    static if(!is(typeof(GL_DIFFERENCE))) {
        private enum enumMixinStr_GL_DIFFERENCE = `enum GL_DIFFERENCE = 0x929E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DIFFERENCE); }))) {
            mixin(enumMixinStr_GL_DIFFERENCE);
        }
    }
    ...
    static if(!is(typeof(GL_EXCLUSION))) {
        private enum enumMixinStr_GL_EXCLUSION = `enum GL_EXCLUSION = 0x92A0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_EXCLUSION); }))) {
            mixin(enumMixinStr_GL_EXCLUSION);
        }
    }
    ...
    static if(!is(typeof(GL_HSL_HUE))) {
        private enum enumMixinStr_GL_HSL_HUE = `enum GL_HSL_HUE = 0x92AD;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_HSL_HUE); }))) {
            mixin(enumMixinStr_GL_HSL_HUE);
        }
    }
    ...
    static if(!is(typeof(GL_HSL_SATURATION))) {
        private enum enumMixinStr_GL_HSL_SATURATION = `enum GL_HSL_SATURATION = 0x92AE;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_HSL_SATURATION); }))) {
            mixin(enumMixinStr_GL_HSL_SATURATION);
        }
    }
    ...
    static if(!is(typeof(GL_HSL_COLOR))) {
        private enum enumMixinStr_GL_HSL_COLOR = `enum GL_HSL_COLOR = 0x92AF;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_HSL_COLOR); }))) {
            mixin(enumMixinStr_GL_HSL_COLOR);
        }
    }
    ...
    static if(!is(typeof(GL_HSL_LUMINOSITY))) {
        private enum enumMixinStr_GL_HSL_LUMINOSITY = `enum GL_HSL_LUMINOSITY = 0x92B0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_HSL_LUMINOSITY); }))) {
            mixin(enumMixinStr_GL_HSL_LUMINOSITY);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_OUTPUT_SYNCHRONOUS))) {
        private enum enumMixinStr_GL_DEBUG_OUTPUT_SYNCHRONOUS = `enum GL_DEBUG_OUTPUT_SYNCHRONOUS = 0x8242;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_OUTPUT_SYNCHRONOUS); }))) {
            mixin(enumMixinStr_GL_DEBUG_OUTPUT_SYNCHRONOUS);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH))) {
        private enum enumMixinStr_GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH = `enum GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH = 0x8243;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH); }))) {
            mixin(enumMixinStr_GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_CALLBACK_FUNCTION))) {
        private enum enumMixinStr_GL_DEBUG_CALLBACK_FUNCTION = `enum GL_DEBUG_CALLBACK_FUNCTION = 0x8244;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_CALLBACK_FUNCTION); }))) {
            mixin(enumMixinStr_GL_DEBUG_CALLBACK_FUNCTION);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_CALLBACK_USER_PARAM))) {
        private enum enumMixinStr_GL_DEBUG_CALLBACK_USER_PARAM = `enum GL_DEBUG_CALLBACK_USER_PARAM = 0x8245;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_CALLBACK_USER_PARAM); }))) {
            mixin(enumMixinStr_GL_DEBUG_CALLBACK_USER_PARAM);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SOURCE_API))) {
        private enum enumMixinStr_GL_DEBUG_SOURCE_API = `enum GL_DEBUG_SOURCE_API = 0x8246;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SOURCE_API); }))) {
            mixin(enumMixinStr_GL_DEBUG_SOURCE_API);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SOURCE_WINDOW_SYSTEM))) {
        private enum enumMixinStr_GL_DEBUG_SOURCE_WINDOW_SYSTEM = `enum GL_DEBUG_SOURCE_WINDOW_SYSTEM = 0x8247;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SOURCE_WINDOW_SYSTEM); }))) {
            mixin(enumMixinStr_GL_DEBUG_SOURCE_WINDOW_SYSTEM);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SOURCE_SHADER_COMPILER))) {
        private enum enumMixinStr_GL_DEBUG_SOURCE_SHADER_COMPILER = `enum GL_DEBUG_SOURCE_SHADER_COMPILER = 0x8248;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SOURCE_SHADER_COMPILER); }))) {
            mixin(enumMixinStr_GL_DEBUG_SOURCE_SHADER_COMPILER);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SOURCE_THIRD_PARTY))) {
        private enum enumMixinStr_GL_DEBUG_SOURCE_THIRD_PARTY = `enum GL_DEBUG_SOURCE_THIRD_PARTY = 0x8249;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SOURCE_THIRD_PARTY); }))) {
            mixin(enumMixinStr_GL_DEBUG_SOURCE_THIRD_PARTY);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SOURCE_APPLICATION))) {
        private enum enumMixinStr_GL_DEBUG_SOURCE_APPLICATION = `enum GL_DEBUG_SOURCE_APPLICATION = 0x824A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SOURCE_APPLICATION); }))) {
            mixin(enumMixinStr_GL_DEBUG_SOURCE_APPLICATION);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SOURCE_OTHER))) {
        private enum enumMixinStr_GL_DEBUG_SOURCE_OTHER = `enum GL_DEBUG_SOURCE_OTHER = 0x824B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SOURCE_OTHER); }))) {
            mixin(enumMixinStr_GL_DEBUG_SOURCE_OTHER);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_ERROR))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_ERROR = `enum GL_DEBUG_TYPE_ERROR = 0x824C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_ERROR); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_ERROR);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR = `enum GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR = 0x824D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR = `enum GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR = 0x824E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_PORTABILITY))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_PORTABILITY = `enum GL_DEBUG_TYPE_PORTABILITY = 0x824F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_PORTABILITY); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_PORTABILITY);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_PERFORMANCE))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_PERFORMANCE = `enum GL_DEBUG_TYPE_PERFORMANCE = 0x8250;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_PERFORMANCE); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_PERFORMANCE);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_OTHER))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_OTHER = `enum GL_DEBUG_TYPE_OTHER = 0x8251;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_OTHER); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_OTHER);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_MARKER))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_MARKER = `enum GL_DEBUG_TYPE_MARKER = 0x8268;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_MARKER); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_MARKER);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_PUSH_GROUP))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_PUSH_GROUP = `enum GL_DEBUG_TYPE_PUSH_GROUP = 0x8269;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_PUSH_GROUP); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_PUSH_GROUP);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_TYPE_POP_GROUP))) {
        private enum enumMixinStr_GL_DEBUG_TYPE_POP_GROUP = `enum GL_DEBUG_TYPE_POP_GROUP = 0x826A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_TYPE_POP_GROUP); }))) {
            mixin(enumMixinStr_GL_DEBUG_TYPE_POP_GROUP);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SEVERITY_NOTIFICATION))) {
        private enum enumMixinStr_GL_DEBUG_SEVERITY_NOTIFICATION = `enum GL_DEBUG_SEVERITY_NOTIFICATION = 0x826B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SEVERITY_NOTIFICATION); }))) {
            mixin(enumMixinStr_GL_DEBUG_SEVERITY_NOTIFICATION);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_DEBUG_GROUP_STACK_DEPTH))) {
        private enum enumMixinStr_GL_MAX_DEBUG_GROUP_STACK_DEPTH = `enum GL_MAX_DEBUG_GROUP_STACK_DEPTH = 0x826C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_DEBUG_GROUP_STACK_DEPTH); }))) {
            mixin(enumMixinStr_GL_MAX_DEBUG_GROUP_STACK_DEPTH);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_GROUP_STACK_DEPTH))) {
        private enum enumMixinStr_GL_DEBUG_GROUP_STACK_DEPTH = `enum GL_DEBUG_GROUP_STACK_DEPTH = 0x826D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_GROUP_STACK_DEPTH); }))) {
            mixin(enumMixinStr_GL_DEBUG_GROUP_STACK_DEPTH);
        }
    }
    ...
    static if(!is(typeof(GL_BUFFER))) {
        private enum enumMixinStr_GL_BUFFER = `enum GL_BUFFER = 0x82E0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_BUFFER); }))) {
            mixin(enumMixinStr_GL_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_SHADER))) {
        private enum enumMixinStr_GL_SHADER = `enum GL_SHADER = 0x82E1;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SHADER); }))) {
            mixin(enumMixinStr_GL_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_PROGRAM))) {
        private enum enumMixinStr_GL_PROGRAM = `enum GL_PROGRAM = 0x82E2;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PROGRAM); }))) {
            mixin(enumMixinStr_GL_PROGRAM);
        }
    }
    ...
    static if(!is(typeof(GL_VERTEX_ARRAY))) {
        private enum enumMixinStr_GL_VERTEX_ARRAY = `enum GL_VERTEX_ARRAY = 0x8074;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_VERTEX_ARRAY); }))) {
            mixin(enumMixinStr_GL_VERTEX_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_QUERY))) {
        private enum enumMixinStr_GL_QUERY = `enum GL_QUERY = 0x82E3;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_QUERY); }))) {
            mixin(enumMixinStr_GL_QUERY);
        }
    }
    ...
    static if(!is(typeof(GL_PROGRAM_PIPELINE))) {
        private enum enumMixinStr_GL_PROGRAM_PIPELINE = `enum GL_PROGRAM_PIPELINE = 0x82E4;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PROGRAM_PIPELINE); }))) {
            mixin(enumMixinStr_GL_PROGRAM_PIPELINE);
        }
    }
    ...
    static if(!is(typeof(GL_SAMPLER))) {
        private enum enumMixinStr_GL_SAMPLER = `enum GL_SAMPLER = 0x82E6;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SAMPLER); }))) {
            mixin(enumMixinStr_GL_SAMPLER);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_LABEL_LENGTH))) {
        private enum enumMixinStr_GL_MAX_LABEL_LENGTH = `enum GL_MAX_LABEL_LENGTH = 0x82E8;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_LABEL_LENGTH); }))) {
            mixin(enumMixinStr_GL_MAX_LABEL_LENGTH);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_DEBUG_MESSAGE_LENGTH))) {
        private enum enumMixinStr_GL_MAX_DEBUG_MESSAGE_LENGTH = `enum GL_MAX_DEBUG_MESSAGE_LENGTH = 0x9143;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_DEBUG_MESSAGE_LENGTH); }))) {
            mixin(enumMixinStr_GL_MAX_DEBUG_MESSAGE_LENGTH);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_DEBUG_LOGGED_MESSAGES))) {
        private enum enumMixinStr_GL_MAX_DEBUG_LOGGED_MESSAGES = `enum GL_MAX_DEBUG_LOGGED_MESSAGES = 0x9144;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_DEBUG_LOGGED_MESSAGES); }))) {
            mixin(enumMixinStr_GL_MAX_DEBUG_LOGGED_MESSAGES);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_LOGGED_MESSAGES))) {
        private enum enumMixinStr_GL_DEBUG_LOGGED_MESSAGES = `enum GL_DEBUG_LOGGED_MESSAGES = 0x9145;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_LOGGED_MESSAGES); }))) {
            mixin(enumMixinStr_GL_DEBUG_LOGGED_MESSAGES);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SEVERITY_HIGH))) {
        private enum enumMixinStr_GL_DEBUG_SEVERITY_HIGH = `enum GL_DEBUG_SEVERITY_HIGH = 0x9146;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SEVERITY_HIGH); }))) {
            mixin(enumMixinStr_GL_DEBUG_SEVERITY_HIGH);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SEVERITY_MEDIUM))) {
        private enum enumMixinStr_GL_DEBUG_SEVERITY_MEDIUM = `enum GL_DEBUG_SEVERITY_MEDIUM = 0x9147;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SEVERITY_MEDIUM); }))) {
            mixin(enumMixinStr_GL_DEBUG_SEVERITY_MEDIUM);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_SEVERITY_LOW))) {
        private enum enumMixinStr_GL_DEBUG_SEVERITY_LOW = `enum GL_DEBUG_SEVERITY_LOW = 0x9148;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_SEVERITY_LOW); }))) {
            mixin(enumMixinStr_GL_DEBUG_SEVERITY_LOW);
        }
    }
    ...
    static if(!is(typeof(GL_DEBUG_OUTPUT))) {
        private enum enumMixinStr_GL_DEBUG_OUTPUT = `enum GL_DEBUG_OUTPUT = 0x92E0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_DEBUG_OUTPUT); }))) {
            mixin(enumMixinStr_GL_DEBUG_OUTPUT);
        }
    }
    ...
    static if(!is(typeof(GL_CONTEXT_FLAG_DEBUG_BIT))) {
        private enum enumMixinStr_GL_CONTEXT_FLAG_DEBUG_BIT = `enum GL_CONTEXT_FLAG_DEBUG_BIT = 0x00000002;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_CONTEXT_FLAG_DEBUG_BIT); }))) {
            mixin(enumMixinStr_GL_CONTEXT_FLAG_DEBUG_BIT);
        }
    }
    ...
    static if(!is(typeof(GL_STACK_OVERFLOW))) {
        private enum enumMixinStr_GL_STACK_OVERFLOW = `enum GL_STACK_OVERFLOW = 0x0503;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_STACK_OVERFLOW); }))) {
            mixin(enumMixinStr_GL_STACK_OVERFLOW);
        }
    }
    ...
    static if(!is(typeof(GL_STACK_UNDERFLOW))) {
        private enum enumMixinStr_GL_STACK_UNDERFLOW = `enum GL_STACK_UNDERFLOW = 0x0504;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_STACK_UNDERFLOW); }))) {
            mixin(enumMixinStr_GL_STACK_UNDERFLOW);
        }
    }
    ...
    static if(!is(typeof(GL_GEOMETRY_SHADER))) {
        private enum enumMixinStr_GL_GEOMETRY_SHADER = `enum GL_GEOMETRY_SHADER = 0x8DD9;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GEOMETRY_SHADER); }))) {
            mixin(enumMixinStr_GL_GEOMETRY_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_GEOMETRY_SHADER_BIT))) {
        private enum enumMixinStr_GL_GEOMETRY_SHADER_BIT = `enum GL_GEOMETRY_SHADER_BIT = 0x00000004;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GEOMETRY_SHADER_BIT); }))) {
            mixin(enumMixinStr_GL_GEOMETRY_SHADER_BIT);
        }
    }
    ...
    static if(!is(typeof(GL_GEOMETRY_VERTICES_OUT))) {
        private enum enumMixinStr_GL_GEOMETRY_VERTICES_OUT = `enum GL_GEOMETRY_VERTICES_OUT = 0x8916;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GEOMETRY_VERTICES_OUT); }))) {
            mixin(enumMixinStr_GL_GEOMETRY_VERTICES_OUT);
        }
    }
    ...
    static if(!is(typeof(GL_GEOMETRY_INPUT_TYPE))) {
        private enum enumMixinStr_GL_GEOMETRY_INPUT_TYPE = `enum GL_GEOMETRY_INPUT_TYPE = 0x8917;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GEOMETRY_INPUT_TYPE); }))) {
            mixin(enumMixinStr_GL_GEOMETRY_INPUT_TYPE);
        }
    }
    ...
    static if(!is(typeof(GL_GEOMETRY_OUTPUT_TYPE))) {
        private enum enumMixinStr_GL_GEOMETRY_OUTPUT_TYPE = `enum GL_GEOMETRY_OUTPUT_TYPE = 0x8918;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GEOMETRY_OUTPUT_TYPE); }))) {
            mixin(enumMixinStr_GL_GEOMETRY_OUTPUT_TYPE);
        }
    }
    ...
    static if(!is(typeof(GL_GEOMETRY_SHADER_INVOCATIONS))) {
        private enum enumMixinStr_GL_GEOMETRY_SHADER_INVOCATIONS = `enum GL_GEOMETRY_SHADER_INVOCATIONS = 0x887F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GEOMETRY_SHADER_INVOCATIONS); }))) {
            mixin(enumMixinStr_GL_GEOMETRY_SHADER_INVOCATIONS);
        }
    }
    ...
    static if(!is(typeof(GL_LAYER_PROVOKING_VERTEX))) {
        private enum enumMixinStr_GL_LAYER_PROVOKING_VERTEX = `enum GL_LAYER_PROVOKING_VERTEX = 0x825E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_LAYER_PROVOKING_VERTEX); }))) {
            mixin(enumMixinStr_GL_LAYER_PROVOKING_VERTEX);
        }
    }
    ...
    static if(!is(typeof(GL_LINES_ADJACENCY))) {
        private enum enumMixinStr_GL_LINES_ADJACENCY = `enum GL_LINES_ADJACENCY = 0x000A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_LINES_ADJACENCY); }))) {
            mixin(enumMixinStr_GL_LINES_ADJACENCY);
        }
    }
    ...
    static if(!is(typeof(GL_LINE_STRIP_ADJACENCY))) {
        private enum enumMixinStr_GL_LINE_STRIP_ADJACENCY = `enum GL_LINE_STRIP_ADJACENCY = 0x000B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_LINE_STRIP_ADJACENCY); }))) {
            mixin(enumMixinStr_GL_LINE_STRIP_ADJACENCY);
        }
    }
    ...
    static if(!is(typeof(GL_TRIANGLES_ADJACENCY))) {
        private enum enumMixinStr_GL_TRIANGLES_ADJACENCY = `enum GL_TRIANGLES_ADJACENCY = 0x000C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TRIANGLES_ADJACENCY); }))) {
            mixin(enumMixinStr_GL_TRIANGLES_ADJACENCY);
        }
    }
    ...
    static if(!is(typeof(GL_TRIANGLE_STRIP_ADJACENCY))) {
        private enum enumMixinStr_GL_TRIANGLE_STRIP_ADJACENCY = `enum GL_TRIANGLE_STRIP_ADJACENCY = 0x000D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TRIANGLE_STRIP_ADJACENCY); }))) {
            mixin(enumMixinStr_GL_TRIANGLE_STRIP_ADJACENCY);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_UNIFORM_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_UNIFORM_COMPONENTS = `enum GL_MAX_GEOMETRY_UNIFORM_COMPONENTS = 0x8DDF;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_UNIFORM_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_UNIFORM_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_UNIFORM_BLOCKS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_UNIFORM_BLOCKS = `enum GL_MAX_GEOMETRY_UNIFORM_BLOCKS = 0x8A2C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_UNIFORM_BLOCKS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_UNIFORM_BLOCKS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS = `enum GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS = 0x8A32;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_INPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_INPUT_COMPONENTS = `enum GL_MAX_GEOMETRY_INPUT_COMPONENTS = 0x9123;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_INPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_INPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_OUTPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_OUTPUT_COMPONENTS = `enum GL_MAX_GEOMETRY_OUTPUT_COMPONENTS = 0x9124;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_OUTPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_OUTPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_OUTPUT_VERTICES))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_OUTPUT_VERTICES = `enum GL_MAX_GEOMETRY_OUTPUT_VERTICES = 0x8DE0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_OUTPUT_VERTICES); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_OUTPUT_VERTICES);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS = `enum GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS = 0x8DE1;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_SHADER_INVOCATIONS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_SHADER_INVOCATIONS = `enum GL_MAX_GEOMETRY_SHADER_INVOCATIONS = 0x8E5A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_SHADER_INVOCATIONS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_SHADER_INVOCATIONS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS = `enum GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS = 0x8C29;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS = `enum GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS = 0x92CF;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_ATOMIC_COUNTERS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_ATOMIC_COUNTERS = `enum GL_MAX_GEOMETRY_ATOMIC_COUNTERS = 0x92D5;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_ATOMIC_COUNTERS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_ATOMIC_COUNTERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_IMAGE_UNIFORMS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_IMAGE_UNIFORMS = `enum GL_MAX_GEOMETRY_IMAGE_UNIFORMS = 0x90CD;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_IMAGE_UNIFORMS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_IMAGE_UNIFORMS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS))) {
        private enum enumMixinStr_GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS = `enum GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS = 0x90D7;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS); }))) {
            mixin(enumMixinStr_GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS);
        }
    }
    ...
    static if(!is(typeof(GL_FIRST_VERTEX_CONVENTION))) {
        private enum enumMixinStr_GL_FIRST_VERTEX_CONVENTION = `enum GL_FIRST_VERTEX_CONVENTION = 0x8E4D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FIRST_VERTEX_CONVENTION); }))) {
            mixin(enumMixinStr_GL_FIRST_VERTEX_CONVENTION);
        }
    }
    ...
    static if(!is(typeof(GL_LAST_VERTEX_CONVENTION))) {
        private enum enumMixinStr_GL_LAST_VERTEX_CONVENTION = `enum GL_LAST_VERTEX_CONVENTION = 0x8E4E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_LAST_VERTEX_CONVENTION); }))) {
            mixin(enumMixinStr_GL_LAST_VERTEX_CONVENTION);
        }
    }
    ...
    static if(!is(typeof(GL_UNDEFINED_VERTEX))) {
        private enum enumMixinStr_GL_UNDEFINED_VERTEX = `enum GL_UNDEFINED_VERTEX = 0x8260;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNDEFINED_VERTEX); }))) {
            mixin(enumMixinStr_GL_UNDEFINED_VERTEX);
        }
    }
    ...
    static if(!is(typeof(GL_PRIMITIVES_GENERATED))) {
        private enum enumMixinStr_GL_PRIMITIVES_GENERATED = `enum GL_PRIMITIVES_GENERATED = 0x8C87;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PRIMITIVES_GENERATED); }))) {
            mixin(enumMixinStr_GL_PRIMITIVES_GENERATED);
        }
    }
    ...
    static if(!is(typeof(GL_FRAMEBUFFER_DEFAULT_LAYERS))) {
        private enum enumMixinStr_GL_FRAMEBUFFER_DEFAULT_LAYERS = `enum GL_FRAMEBUFFER_DEFAULT_LAYERS = 0x9312;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FRAMEBUFFER_DEFAULT_LAYERS); }))) {
            mixin(enumMixinStr_GL_FRAMEBUFFER_DEFAULT_LAYERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_FRAMEBUFFER_LAYERS))) {
        private enum enumMixinStr_GL_MAX_FRAMEBUFFER_LAYERS = `enum GL_MAX_FRAMEBUFFER_LAYERS = 0x9317;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_FRAMEBUFFER_LAYERS); }))) {
            mixin(enumMixinStr_GL_MAX_FRAMEBUFFER_LAYERS);
        }
    }
    ...
    static if(!is(typeof(GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS))) {
        private enum enumMixinStr_GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS = `enum GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS = 0x8DA8;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS); }))) {
            mixin(enumMixinStr_GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS);
        }
    }
    ...
    static if(!is(typeof(GL_FRAMEBUFFER_ATTACHMENT_LAYERED))) {
        private enum enumMixinStr_GL_FRAMEBUFFER_ATTACHMENT_LAYERED = `enum GL_FRAMEBUFFER_ATTACHMENT_LAYERED = 0x8DA7;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FRAMEBUFFER_ATTACHMENT_LAYERED); }))) {
            mixin(enumMixinStr_GL_FRAMEBUFFER_ATTACHMENT_LAYERED);
        }
    }
    ...
    static if(!is(typeof(GL_REFERENCED_BY_GEOMETRY_SHADER))) {
        private enum enumMixinStr_GL_REFERENCED_BY_GEOMETRY_SHADER = `enum GL_REFERENCED_BY_GEOMETRY_SHADER = 0x9309;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_REFERENCED_BY_GEOMETRY_SHADER); }))) {
            mixin(enumMixinStr_GL_REFERENCED_BY_GEOMETRY_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_PRIMITIVE_BOUNDING_BOX))) {
        private enum enumMixinStr_GL_PRIMITIVE_BOUNDING_BOX = `enum GL_PRIMITIVE_BOUNDING_BOX = 0x92BE;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PRIMITIVE_BOUNDING_BOX); }))) {
            mixin(enumMixinStr_GL_PRIMITIVE_BOUNDING_BOX);
        }
    }
    ...
    static if(!is(typeof(GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT))) {
        private enum enumMixinStr_GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT = `enum GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT = 0x00000004;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT); }))) {
            mixin(enumMixinStr_GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT);
        }
    }
    ...
    static if(!is(typeof(GL_CONTEXT_FLAGS))) {
        private enum enumMixinStr_GL_CONTEXT_FLAGS = `enum GL_CONTEXT_FLAGS = 0x821E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_CONTEXT_FLAGS); }))) {
            mixin(enumMixinStr_GL_CONTEXT_FLAGS);
        }
    }
    ...
    static if(!is(typeof(GL_LOSE_CONTEXT_ON_RESET))) {
        private enum enumMixinStr_GL_LOSE_CONTEXT_ON_RESET = `enum GL_LOSE_CONTEXT_ON_RESET = 0x8252;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_LOSE_CONTEXT_ON_RESET); }))) {
            mixin(enumMixinStr_GL_LOSE_CONTEXT_ON_RESET);
        }
    }
    ...
    static if(!is(typeof(GL_GUILTY_CONTEXT_RESET))) {
        private enum enumMixinStr_GL_GUILTY_CONTEXT_RESET = `enum GL_GUILTY_CONTEXT_RESET = 0x8253;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_GUILTY_CONTEXT_RESET); }))) {
            mixin(enumMixinStr_GL_GUILTY_CONTEXT_RESET);
        }
    }
    ...
    static if(!is(typeof(GL_INNOCENT_CONTEXT_RESET))) {
        private enum enumMixinStr_GL_INNOCENT_CONTEXT_RESET = `enum GL_INNOCENT_CONTEXT_RESET = 0x8254;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_INNOCENT_CONTEXT_RESET); }))) {
            mixin(enumMixinStr_GL_INNOCENT_CONTEXT_RESET);
        }
    }
    ...
    static if(!is(typeof(GL_UNKNOWN_CONTEXT_RESET))) {
        private enum enumMixinStr_GL_UNKNOWN_CONTEXT_RESET = `enum GL_UNKNOWN_CONTEXT_RESET = 0x8255;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNKNOWN_CONTEXT_RESET); }))) {
            mixin(enumMixinStr_GL_UNKNOWN_CONTEXT_RESET);
        }
    }
    ...
    static if(!is(typeof(GL_RESET_NOTIFICATION_STRATEGY))) {
        private enum enumMixinStr_GL_RESET_NOTIFICATION_STRATEGY = `enum GL_RESET_NOTIFICATION_STRATEGY = 0x8256;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_RESET_NOTIFICATION_STRATEGY); }))) {
            mixin(enumMixinStr_GL_RESET_NOTIFICATION_STRATEGY);
        }
    }
    ...
    static if(!is(typeof(GL_NO_RESET_NOTIFICATION))) {
        private enum enumMixinStr_GL_NO_RESET_NOTIFICATION = `enum GL_NO_RESET_NOTIFICATION = 0x8261;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_NO_RESET_NOTIFICATION); }))) {
            mixin(enumMixinStr_GL_NO_RESET_NOTIFICATION);
        }
    }
    ...
    static if(!is(typeof(GL_CONTEXT_LOST))) {
        private enum enumMixinStr_GL_CONTEXT_LOST = `enum GL_CONTEXT_LOST = 0x0507;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_CONTEXT_LOST); }))) {
            mixin(enumMixinStr_GL_CONTEXT_LOST);
        }
    }
    ...
    static if(!is(typeof(GL_SAMPLE_SHADING))) {
        private enum enumMixinStr_GL_SAMPLE_SHADING = `enum GL_SAMPLE_SHADING = 0x8C36;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SAMPLE_SHADING); }))) {
            mixin(enumMixinStr_GL_SAMPLE_SHADING);
        }
    }
    ...
    static if(!is(typeof(GL_MIN_SAMPLE_SHADING_VALUE))) {
        private enum enumMixinStr_GL_MIN_SAMPLE_SHADING_VALUE = `enum GL_MIN_SAMPLE_SHADING_VALUE = 0x8C37;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MIN_SAMPLE_SHADING_VALUE); }))) {
            mixin(enumMixinStr_GL_MIN_SAMPLE_SHADING_VALUE);
        }
    }
    ...
    static if(!is(typeof(GL_MIN_FRAGMENT_INTERPOLATION_OFFSET))) {
        private enum enumMixinStr_GL_MIN_FRAGMENT_INTERPOLATION_OFFSET = `enum GL_MIN_FRAGMENT_INTERPOLATION_OFFSET = 0x8E5B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MIN_FRAGMENT_INTERPOLATION_OFFSET); }))) {
            mixin(enumMixinStr_GL_MIN_FRAGMENT_INTERPOLATION_OFFSET);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_FRAGMENT_INTERPOLATION_OFFSET))) {
        private enum enumMixinStr_GL_MAX_FRAGMENT_INTERPOLATION_OFFSET = `enum GL_MAX_FRAGMENT_INTERPOLATION_OFFSET = 0x8E5C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_FRAGMENT_INTERPOLATION_OFFSET); }))) {
            mixin(enumMixinStr_GL_MAX_FRAGMENT_INTERPOLATION_OFFSET);
        }
    }
    ...
    static if(!is(typeof(GL_FRAGMENT_INTERPOLATION_OFFSET_BITS))) {
        private enum enumMixinStr_GL_FRAGMENT_INTERPOLATION_OFFSET_BITS = `enum GL_FRAGMENT_INTERPOLATION_OFFSET_BITS = 0x8E5D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FRAGMENT_INTERPOLATION_OFFSET_BITS); }))) {
            mixin(enumMixinStr_GL_FRAGMENT_INTERPOLATION_OFFSET_BITS);
        }
    }
    ...
    static if(!is(typeof(GL_PATCHES))) {
        private enum enumMixinStr_GL_PATCHES = `enum GL_PATCHES = 0x000E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PATCHES); }))) {
            mixin(enumMixinStr_GL_PATCHES);
        }
    }
    ...
    static if(!is(typeof(GL_PATCH_VERTICES))) {
        private enum enumMixinStr_GL_PATCH_VERTICES = `enum GL_PATCH_VERTICES = 0x8E72;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PATCH_VERTICES); }))) {
            mixin(enumMixinStr_GL_PATCH_VERTICES);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_CONTROL_OUTPUT_VERTICES))) {
        private enum enumMixinStr_GL_TESS_CONTROL_OUTPUT_VERTICES = `enum GL_TESS_CONTROL_OUTPUT_VERTICES = 0x8E75;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_CONTROL_OUTPUT_VERTICES); }))) {
            mixin(enumMixinStr_GL_TESS_CONTROL_OUTPUT_VERTICES);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_GEN_MODE))) {
        private enum enumMixinStr_GL_TESS_GEN_MODE = `enum GL_TESS_GEN_MODE = 0x8E76;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_GEN_MODE); }))) {
            mixin(enumMixinStr_GL_TESS_GEN_MODE);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_GEN_SPACING))) {
        private enum enumMixinStr_GL_TESS_GEN_SPACING = `enum GL_TESS_GEN_SPACING = 0x8E77;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_GEN_SPACING); }))) {
            mixin(enumMixinStr_GL_TESS_GEN_SPACING);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_GEN_VERTEX_ORDER))) {
        private enum enumMixinStr_GL_TESS_GEN_VERTEX_ORDER = `enum GL_TESS_GEN_VERTEX_ORDER = 0x8E78;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_GEN_VERTEX_ORDER); }))) {
            mixin(enumMixinStr_GL_TESS_GEN_VERTEX_ORDER);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_GEN_POINT_MODE))) {
        private enum enumMixinStr_GL_TESS_GEN_POINT_MODE = `enum GL_TESS_GEN_POINT_MODE = 0x8E79;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_GEN_POINT_MODE); }))) {
            mixin(enumMixinStr_GL_TESS_GEN_POINT_MODE);
        }
    }
    ...
    static if(!is(typeof(GL_ISOLINES))) {
        private enum enumMixinStr_GL_ISOLINES = `enum GL_ISOLINES = 0x8E7A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_ISOLINES); }))) {
            mixin(enumMixinStr_GL_ISOLINES);
        }
    }
    ...
    static if(!is(typeof(GL_QUADS))) {
        private enum enumMixinStr_GL_QUADS = `enum GL_QUADS = 0x0007;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_QUADS); }))) {
            mixin(enumMixinStr_GL_QUADS);
        }
    }
    ...
    static if(!is(typeof(GL_FRACTIONAL_ODD))) {
        private enum enumMixinStr_GL_FRACTIONAL_ODD = `enum GL_FRACTIONAL_ODD = 0x8E7B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FRACTIONAL_ODD); }))) {
            mixin(enumMixinStr_GL_FRACTIONAL_ODD);
        }
    }
    ...
    static if(!is(typeof(GL_FRACTIONAL_EVEN))) {
        private enum enumMixinStr_GL_FRACTIONAL_EVEN = `enum GL_FRACTIONAL_EVEN = 0x8E7C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_FRACTIONAL_EVEN); }))) {
            mixin(enumMixinStr_GL_FRACTIONAL_EVEN);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_PATCH_VERTICES))) {
        private enum enumMixinStr_GL_MAX_PATCH_VERTICES = `enum GL_MAX_PATCH_VERTICES = 0x8E7D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_PATCH_VERTICES); }))) {
            mixin(enumMixinStr_GL_MAX_PATCH_VERTICES);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_GEN_LEVEL))) {
        private enum enumMixinStr_GL_MAX_TESS_GEN_LEVEL = `enum GL_MAX_TESS_GEN_LEVEL = 0x8E7E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_GEN_LEVEL); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_GEN_LEVEL);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS = `enum GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS = 0x8E7F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS = `enum GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS = 0x8E80;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS = `enum GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS = 0x8E81;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS = `enum GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS = 0x8E82;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS = `enum GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS = 0x8E83;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_PATCH_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_PATCH_COMPONENTS = `enum GL_MAX_TESS_PATCH_COMPONENTS = 0x8E84;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_PATCH_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_PATCH_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS = `enum GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS = 0x8E85;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS = `enum GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS = 0x8E86;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS = `enum GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS = 0x8E89;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS = `enum GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS = 0x8E8A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_INPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_INPUT_COMPONENTS = `enum GL_MAX_TESS_CONTROL_INPUT_COMPONENTS = 0x886C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_INPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_INPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS = `enum GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS = 0x886D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS = `enum GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS = 0x8E1E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS))) {
        private enum enumMixinStr_GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS = `enum GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS = 0x8E1F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS); }))) {
            mixin(enumMixinStr_GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS = `enum GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS = 0x92CD;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS = `enum GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS = 0x92CE;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS = `enum GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS = 0x92D3;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS = `enum GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS = 0x92D4;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS = `enum GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS = 0x90CB;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS = `enum GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS = 0x90CC;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS))) {
        private enum enumMixinStr_GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS = `enum GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS = 0x90D8;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS))) {
        private enum enumMixinStr_GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS = `enum GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS = 0x90D9;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS); }))) {
            mixin(enumMixinStr_GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS);
        }
    }
    ...
    static if(!is(typeof(GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED))) {
        private enum enumMixinStr_GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED = `enum GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED = 0x8221;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED); }))) {
            mixin(enumMixinStr_GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED);
        }
    }
    ...
    static if(!is(typeof(GL_IS_PER_PATCH))) {
        private enum enumMixinStr_GL_IS_PER_PATCH = `enum GL_IS_PER_PATCH = 0x92E7;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_IS_PER_PATCH); }))) {
            mixin(enumMixinStr_GL_IS_PER_PATCH);
        }
    }
    ...
    static if(!is(typeof(GL_REFERENCED_BY_TESS_CONTROL_SHADER))) {
        private enum enumMixinStr_GL_REFERENCED_BY_TESS_CONTROL_SHADER = `enum GL_REFERENCED_BY_TESS_CONTROL_SHADER = 0x9307;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_REFERENCED_BY_TESS_CONTROL_SHADER); }))) {
            mixin(enumMixinStr_GL_REFERENCED_BY_TESS_CONTROL_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_REFERENCED_BY_TESS_EVALUATION_SHADER))) {
        private enum enumMixinStr_GL_REFERENCED_BY_TESS_EVALUATION_SHADER = `enum GL_REFERENCED_BY_TESS_EVALUATION_SHADER = 0x9308;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_REFERENCED_BY_TESS_EVALUATION_SHADER); }))) {
            mixin(enumMixinStr_GL_REFERENCED_BY_TESS_EVALUATION_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_CONTROL_SHADER))) {
        private enum enumMixinStr_GL_TESS_CONTROL_SHADER = `enum GL_TESS_CONTROL_SHADER = 0x8E88;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_CONTROL_SHADER); }))) {
            mixin(enumMixinStr_GL_TESS_CONTROL_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_EVALUATION_SHADER))) {
        private enum enumMixinStr_GL_TESS_EVALUATION_SHADER = `enum GL_TESS_EVALUATION_SHADER = 0x8E87;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_EVALUATION_SHADER); }))) {
            mixin(enumMixinStr_GL_TESS_EVALUATION_SHADER);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_CONTROL_SHADER_BIT))) {
        private enum enumMixinStr_GL_TESS_CONTROL_SHADER_BIT = `enum GL_TESS_CONTROL_SHADER_BIT = 0x00000008;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_CONTROL_SHADER_BIT); }))) {
            mixin(enumMixinStr_GL_TESS_CONTROL_SHADER_BIT);
        }
    }
    ...
    static if(!is(typeof(GL_TESS_EVALUATION_SHADER_BIT))) {
        private enum enumMixinStr_GL_TESS_EVALUATION_SHADER_BIT = `enum GL_TESS_EVALUATION_SHADER_BIT = 0x00000010;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TESS_EVALUATION_SHADER_BIT); }))) {
            mixin(enumMixinStr_GL_TESS_EVALUATION_SHADER_BIT);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BORDER_COLOR))) {
        private enum enumMixinStr_GL_TEXTURE_BORDER_COLOR = `enum GL_TEXTURE_BORDER_COLOR = 0x1004;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BORDER_COLOR); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BORDER_COLOR);
        }
    }
    ...
    static if(!is(typeof(GL_CLAMP_TO_BORDER))) {
        private enum enumMixinStr_GL_CLAMP_TO_BORDER = `enum GL_CLAMP_TO_BORDER = 0x812D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_CLAMP_TO_BORDER); }))) {
            mixin(enumMixinStr_GL_CLAMP_TO_BORDER);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BUFFER))) {
        private enum enumMixinStr_GL_TEXTURE_BUFFER = `enum GL_TEXTURE_BUFFER = 0x8C2A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BUFFER); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BUFFER_BINDING))) {
        private enum enumMixinStr_GL_TEXTURE_BUFFER_BINDING = `enum GL_TEXTURE_BUFFER_BINDING = 0x8C2A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BUFFER_BINDING); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BUFFER_BINDING);
        }
    }
    ...
    static if(!is(typeof(GL_MAX_TEXTURE_BUFFER_SIZE))) {
        private enum enumMixinStr_GL_MAX_TEXTURE_BUFFER_SIZE = `enum GL_MAX_TEXTURE_BUFFER_SIZE = 0x8C2B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_MAX_TEXTURE_BUFFER_SIZE); }))) {
            mixin(enumMixinStr_GL_MAX_TEXTURE_BUFFER_SIZE);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BINDING_BUFFER))) {
        private enum enumMixinStr_GL_TEXTURE_BINDING_BUFFER = `enum GL_TEXTURE_BINDING_BUFFER = 0x8C2C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BINDING_BUFFER); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BINDING_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BUFFER_DATA_STORE_BINDING))) {
        private enum enumMixinStr_GL_TEXTURE_BUFFER_DATA_STORE_BINDING = `enum GL_TEXTURE_BUFFER_DATA_STORE_BINDING = 0x8C2D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BUFFER_DATA_STORE_BINDING); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BUFFER_DATA_STORE_BINDING);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT))) {
        private enum enumMixinStr_GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT = `enum GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT = 0x919F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT);
        }
    }
    ...
    static if(!is(typeof(GL_SAMPLER_BUFFER))) {
        private enum enumMixinStr_GL_SAMPLER_BUFFER = `enum GL_SAMPLER_BUFFER = 0x8DC2;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SAMPLER_BUFFER); }))) {
            mixin(enumMixinStr_GL_SAMPLER_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_INT_SAMPLER_BUFFER))) {
        private enum enumMixinStr_GL_INT_SAMPLER_BUFFER = `enum GL_INT_SAMPLER_BUFFER = 0x8DD0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_INT_SAMPLER_BUFFER); }))) {
            mixin(enumMixinStr_GL_INT_SAMPLER_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_UNSIGNED_INT_SAMPLER_BUFFER))) {
        private enum enumMixinStr_GL_UNSIGNED_INT_SAMPLER_BUFFER = `enum GL_UNSIGNED_INT_SAMPLER_BUFFER = 0x8DD8;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNSIGNED_INT_SAMPLER_BUFFER); }))) {
            mixin(enumMixinStr_GL_UNSIGNED_INT_SAMPLER_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_IMAGE_BUFFER))) {
        private enum enumMixinStr_GL_IMAGE_BUFFER = `enum GL_IMAGE_BUFFER = 0x9051;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_IMAGE_BUFFER); }))) {
            mixin(enumMixinStr_GL_IMAGE_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_INT_IMAGE_BUFFER))) {
        private enum enumMixinStr_GL_INT_IMAGE_BUFFER = `enum GL_INT_IMAGE_BUFFER = 0x905C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_INT_IMAGE_BUFFER); }))) {
            mixin(enumMixinStr_GL_INT_IMAGE_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_UNSIGNED_INT_IMAGE_BUFFER))) {
        private enum enumMixinStr_GL_UNSIGNED_INT_IMAGE_BUFFER = `enum GL_UNSIGNED_INT_IMAGE_BUFFER = 0x9067;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNSIGNED_INT_IMAGE_BUFFER); }))) {
            mixin(enumMixinStr_GL_UNSIGNED_INT_IMAGE_BUFFER);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BUFFER_OFFSET))) {
        private enum enumMixinStr_GL_TEXTURE_BUFFER_OFFSET = `enum GL_TEXTURE_BUFFER_OFFSET = 0x919D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BUFFER_OFFSET); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BUFFER_OFFSET);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BUFFER_SIZE))) {
        private enum enumMixinStr_GL_TEXTURE_BUFFER_SIZE = `enum GL_TEXTURE_BUFFER_SIZE = 0x919E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BUFFER_SIZE); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BUFFER_SIZE);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_4x4))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_4x4 = `enum GL_COMPRESSED_RGBA_ASTC_4x4 = 0x93B0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_4x4); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_4x4);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_5x4))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_5x4 = `enum GL_COMPRESSED_RGBA_ASTC_5x4 = 0x93B1;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_5x4); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_5x4);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_5x5))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_5x5 = `enum GL_COMPRESSED_RGBA_ASTC_5x5 = 0x93B2;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_5x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_5x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_6x5))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_6x5 = `enum GL_COMPRESSED_RGBA_ASTC_6x5 = 0x93B3;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_6x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_6x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_6x6))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_6x6 = `enum GL_COMPRESSED_RGBA_ASTC_6x6 = 0x93B4;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_6x6); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_6x6);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_8x5))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x5 = `enum GL_COMPRESSED_RGBA_ASTC_8x5 = 0x93B5;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_8x6))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x6 = `enum GL_COMPRESSED_RGBA_ASTC_8x6 = 0x93B6;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x6); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x6);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_8x8))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x8 = `enum GL_COMPRESSED_RGBA_ASTC_8x8 = 0x93B7;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x8); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_8x8);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_10x5))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x5 = `enum GL_COMPRESSED_RGBA_ASTC_10x5 = 0x93B8;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_10x6))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x6 = `enum GL_COMPRESSED_RGBA_ASTC_10x6 = 0x93B9;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x6); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x6);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_10x8))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x8 = `enum GL_COMPRESSED_RGBA_ASTC_10x8 = 0x93BA;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x8); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x8);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_10x10))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x10 = `enum GL_COMPRESSED_RGBA_ASTC_10x10 = 0x93BB;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x10); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_10x10);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_12x10))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_12x10 = `enum GL_COMPRESSED_RGBA_ASTC_12x10 = 0x93BC;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_12x10); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_12x10);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_RGBA_ASTC_12x12))) {
        private enum enumMixinStr_GL_COMPRESSED_RGBA_ASTC_12x12 = `enum GL_COMPRESSED_RGBA_ASTC_12x12 = 0x93BD;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_12x12); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_RGBA_ASTC_12x12);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4 = 0x93D0;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4 = 0x93D1;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5 = 0x93D2;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5 = 0x93D3;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6 = 0x93D4;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5 = 0x93D5;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6 = 0x93D6;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8 = 0x93D7;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5 = 0x93D8;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6 = 0x93D9;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8 = 0x93DA;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10 = 0x93DB;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10 = 0x93DC;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10);
        }
    }
    ...
    static if(!is(typeof(GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12))) {
        private enum enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12 = `enum GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12 = 0x93DD;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12); }))) {
            mixin(enumMixinStr_GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_TEXTURE_CUBE_MAP_ARRAY = `enum GL_TEXTURE_CUBE_MAP_ARRAY = 0x9009;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_TEXTURE_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BINDING_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_TEXTURE_BINDING_CUBE_MAP_ARRAY = `enum GL_TEXTURE_BINDING_CUBE_MAP_ARRAY = 0x900A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BINDING_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BINDING_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_SAMPLER_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_SAMPLER_CUBE_MAP_ARRAY = `enum GL_SAMPLER_CUBE_MAP_ARRAY = 0x900C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SAMPLER_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_SAMPLER_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW))) {
        private enum enumMixinStr_GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW = `enum GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW = 0x900D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW); }))) {
            mixin(enumMixinStr_GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW);
        }
    }
    ...
    static if(!is(typeof(GL_INT_SAMPLER_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_INT_SAMPLER_CUBE_MAP_ARRAY = `enum GL_INT_SAMPLER_CUBE_MAP_ARRAY = 0x900E;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_INT_SAMPLER_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_INT_SAMPLER_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY = `enum GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY = 0x900F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_IMAGE_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_IMAGE_CUBE_MAP_ARRAY = `enum GL_IMAGE_CUBE_MAP_ARRAY = 0x9054;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_IMAGE_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_IMAGE_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_INT_IMAGE_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_INT_IMAGE_CUBE_MAP_ARRAY = `enum GL_INT_IMAGE_CUBE_MAP_ARRAY = 0x905F;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_INT_IMAGE_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_INT_IMAGE_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY))) {
        private enum enumMixinStr_GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY = `enum GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY = 0x906A;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY); }))) {
            mixin(enumMixinStr_GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_2D_MULTISAMPLE_ARRAY))) {
        private enum enumMixinStr_GL_TEXTURE_2D_MULTISAMPLE_ARRAY = `enum GL_TEXTURE_2D_MULTISAMPLE_ARRAY = 0x9102;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_2D_MULTISAMPLE_ARRAY); }))) {
            mixin(enumMixinStr_GL_TEXTURE_2D_MULTISAMPLE_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY))) {
        private enum enumMixinStr_GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY = `enum GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY = 0x9105;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY); }))) {
            mixin(enumMixinStr_GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_SAMPLER_2D_MULTISAMPLE_ARRAY))) {
        private enum enumMixinStr_GL_SAMPLER_2D_MULTISAMPLE_ARRAY = `enum GL_SAMPLER_2D_MULTISAMPLE_ARRAY = 0x910B;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_SAMPLER_2D_MULTISAMPLE_ARRAY); }))) {
            mixin(enumMixinStr_GL_SAMPLER_2D_MULTISAMPLE_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY))) {
        private enum enumMixinStr_GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY = `enum GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY = 0x910C;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY); }))) {
            mixin(enumMixinStr_GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY);
        }
    }
    ...
    static if(!is(typeof(GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY))) {
        private enum enumMixinStr_GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY = `enum GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY = 0x910D;`;
        static if(is(typeof({ mixin(enumMixinStr_GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY); }))) {
            mixin(enumMixinStr_GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY);
        }
    }
    ...
    static if(!is(typeof(__gl32_h_))) {
        private enum enumMixinStr___gl32_h_ = `enum __gl32_h_ = 1;`;
        static if(is(typeof({ mixin(enumMixinStr___gl32_h_); }))) {
            mixin(enumMixinStr___gl32_h_);
        }
    }
...
;`;
    ...
    static if(!is(typeof(__FILEW__))) {
        private enum enumMixinStr___FILEW__ = `enum __FILEW__ = L".\\gl32.d.tmp";`;
