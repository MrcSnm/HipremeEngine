...
extern(C)
{
    ...
    static if(!is(typeof(__gl3_h_))) {
        private enum enumMixinStr___gl3_h_ = `enum __gl3_h_ = 1;`;
        static if(is(typeof({ mixin(enumMixinStr___gl3_h_); }))) {
            mixin(enumMixinStr___gl3_h_);
        }
    }
...
;`;
    ...
    static if(!is(typeof(__FILEW__))) {
        private enum enumMixinStr___FILEW__ = `enum __FILEW__ = L".\\gl3.d.tmp";`;
